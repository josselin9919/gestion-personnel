<x-app-layout>
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Modifier le projet : {{ $projet->nom_projet }}</h1>
        <a href="{{ route('projets.show', $projet) }}" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200">
        ...
        <form action="{{ route('projets.update', $projet) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nom_projet" id="nom_projet" value="{{ old('nom_projet', $projet->nom_projet) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="nom_client" id="nom_client" value="{{ old('nom_client', $projet->nom_client) }}" 
            ...
            <div class="mt-6">
                ...
                <textarea name="description" id="description" rows="4" 
                          ...
                          placeholder="Description détaillée du projet...">{{ old('description', $projet->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end space-x-4 mt-8">
                <a href="{{ route('projets.show', $projet) }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors duration-200">
                    Annuler
                </a>
