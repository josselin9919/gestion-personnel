                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route("evaluations.store") }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="personnel_temporaire_id" id="personnel_temporaire_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                @foreach ($personnels as $personnel)
                                    <option value="{{ $personnel->id }}" {{ old("personnel_temporaire_id") == $personnel->id ? "selected" : "" }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="evaluateur_nom" id="evaluateur_nom" value="{{ old("evaluateur_nom") }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date_evaluation" id="date_evaluation" value="{{ old("date_evaluation") }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                html += `
                                    <div class="mb-4 p-4 border border-gray-200 rounded-lg">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <input type="number" name="notes[${index}][note]" id="notes_${critere.id}_note" min="0" max="5" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                        </div>
                                    </div>
                                `;
                            });
